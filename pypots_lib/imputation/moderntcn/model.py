...
class ModernTCN(BaseNNImputer):
    """The PyTorch implementation of the ModernTCN model.
    ModernTCN is originally proposed by Luo et al. in :cite:`luo2024moderntcn`.
    ...
    def __init__(
        ...
        # If using ORTMITLoss, pass MIT_weight, ORT_weight, and base loss
